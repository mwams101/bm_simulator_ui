            ...
            <div className="relative z-10 w-full max-w-[560px] bg-white dark:bg-[#161e2e] rounded-2xl shadow-2xl border border-[#e7ebf3] dark:border-gray-800 overflow-hidden">
                <div className="px-8 pt-8 pb-6 border-b border-[#f0f2f5] dark:border-gray-800">
                    <div className="flex items-center justify-between mb-2">
                        <h1 className="text-2xl font-black text-[#0d121b] dark:text-white tracking-tight">Edit User</h1>
                    ...
                    <p className="text-[#4c669a] dark:text-gray-400 text-sm">Editing: {user.user_name}</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-6">
                    <div className="space-y-2">
                        <label className="text-sm font-bold text-[#0d121b] dark:text-gray-200" htmlFor="user_name">Username</label>
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-bold text-[#0d121b] dark:text-gray-200" htmlFor="email">Email Address</label>
                        <div className="relative">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-bold text-[#0d121b] dark:text-gray-200" htmlFor="role">User Role</label>
                            <div className="relative">
                ...
                <div className="bg-gray-50 dark:bg-gray-900/50 px-8 py-4 border-t border-[#f0f2f5] dark:border-gray-800 flex items-start gap-3">
                    ...
                    <p className="text-[11px] leading-relaxed text-[#4c669a] dark:text-gray-400 font-medium">
                        <span className="text-primary font-bold">Edit Mode:</span> Changes apply immediately. Leave the password field blank to keep the existing password unchanged.
                    </p>
                </div>
            </div>
        </div>
