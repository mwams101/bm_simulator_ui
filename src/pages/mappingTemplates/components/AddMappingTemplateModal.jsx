...
const AddMappingTemplateModal = ({ isOpen, onClose, onTemplateCreated }) => {
    ...
    const footer = (
        <div className="flex items-start gap-3">
            ...
            <p className="text-[11px] leading-relaxed text-[#4c669a] dark:text-gray-400 font-medium">
                <span className="text-primary font-bold">Reusable Templates:</span> Create mapping templates that can be reused across multiple migration workflows for consistency and efficiency.
            </p>
        </div>
    );
    ...
    return (
        <Modal
            ...
            description="Define a new reusable mapping configuration for your data migrations."
            footer={footer}
        >
            <div className="p-8">
                {error && (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-[#e7ebf3] dark:border-gray-700">
                        <div className="flex items-center gap-3">
                            ...
                            />
                            <label htmlFor="is_active" className="flex items-center gap-2 text-sm font-medium text-[#0d121b] dark:text-gray-200 cursor-pointer">
                                <span className="material-symbols-outlined text-emerald-500 text-lg">toggle_on</span>
                                Set template as active immediately
                            </label>
                        </div>
...
export default AddMappingTemplateModal;