...
const LoginPage = () => {
    ...
    return (
        // Login page (fixed colors to match index.css theme tokens)
        ...
        <span className="material-symbols-outlined text-primary text-3xl">
          swap_horiz
                ...
                {/* Login Card */}
                <div className="bg-brand-subtle-bg-light dark:bg-brand-subtle-bg-dark rounded-xl shadow-lg border border-brand-border-light dark:border-brand-border-dark p-8">
